  ...
  try {
    ...
    if (!domainExists) {
      ...
      return {
        status: 400,
        message:
          "Maksimum domain sayısına ulaştınız, lütfen aboneliğinizi yükseltin",
      };
    }

    return {
      status: 400,
      message: "Domain zaten mevcut",
    };
  } catch (error) {
    console.log(error);
  }
...
export const onChatBotImageUpdate = async (id: string, icon: string) => {
  ...
  try {
    ...
    if (domain) {
      return {
        status: 200,
        message: "Chatbot resmi başarıyla güncellendi",
      };
    }
...
export const onUpdateWelcomeMessage = async (
  ...
  try {
    ...
    if (update) {
      return {
        status: 200,
        message: "Hoşgeldin mesajı başarıyla güncellendi",
      };
    }
  } catch (e) {
    console.log(e);
  ...
  try {
    ...
    if (validUser) {
      ...
      if (deletedDomain) {
        return {
          status: 200,
          message: `${deletedDomain.name} domaini başarıyla silindi`,
        };
      }
    }
  } catch (e) {
...
export const onCreateHelpDeskQuestion = async (
  ...
  try {
    ...
    if (helpDeskQuestion) {
      return {
        status: 200,
        message: "Yeni destek sorunuz eklendi",
...
export const onGetAllHelpDeskQuestions = async (id: string) => {
  try {
    ...
    if (questions) {
      return {
        status: 200,
        message: "Yeni destek sorusu eklendi",
        questions: questions,
      };
    }
    ...
    return {
      status: 400,
      message: "Destek sorusu eklenemedi",
      questions: [],
    };
  } catch (e) {
    console.log("[onGetAllHepDeskQuestions]", e);
  }
};
...
export const onCreateFilterQuestions = async (id: string, question: string) => {
  try {
    ...
    if(filterQuestion) {
      return {
        status: 200, 
        message: "Yeni filtre sorusu eklendi",
    ...
    return {
      status: 400,
      message: "Filtre sorusu eklenemedi",
    }
  } catch (e) {
    console.log("[onCreateFilterQuestions]", e);
  }
};
...
export const onGetAllFilterQuestions = async (id: string) => {
  try {
    ...
    console.log("[onGetAllFilterQuestions]", e)
  }
}